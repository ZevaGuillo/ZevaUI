...
//
// The choreography is the shared one in @zevaui/config/gate-harness and the
// storybook wiring is ./run-visual-gate.js. What makes this gate different is
// the fixture, and what its failure means:
//
...
// The frame is asserted structurally by run-visual-gate.js.
import { runVisualGate } from "./run-visual-gate.js";

runVisualGate({
  label: "visual-overlay-gate",
  configFile: "vitest.visual-overlay-gate.config.ts",
  storyFile: "BrokenVisualOverlay.stories.tsx",
